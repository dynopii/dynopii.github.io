...
export const landingContents = {
  ...
  landingDescription:
    "Effective communication is not easy. We help you provide unique personalized communication to your customers helping them understand your business better. Never before in the industry and surely nowhere else.",
...
export const aboutUsContents = {
  ...
  teamsSection: {
    title: "Our Team",
    description:
      "We brought together amazing people with a passion to shake the world.",
  },
  // Strategic Partners
  StrategicPartners: {
...
export const footerContents = {
  copyright: `Copyright © ${new Date().getFullYear()} Dynopii, Inc. All rights reserved.`,
    ...
    },
    {
      ...
      subLinks: [
        ...
        },
        {
          id: "7",
          title: "Career",
          href: "https://angel.co/company/dynopii/jobs",
          spanText: `We're hiring`,
          inDOM: false,
        },
      ],
    },
...
export const smallBlogs = [
  ...
  },
  {
    id: "4",
    title:
      "Indian AI startup Dynopii debuts voice accent changer with Computex 2021",
