...
export const TeamCard: React.FC<Props> = () => {
	return (
		<div className="mt-70 md:mt-40 w-44 md:mx-40">
			...
			<h5 className="text-gray-f2f text-h5 font-semibold mt-25">Julia DeWahl</h5>
			<p className="text-gray-bdb font-normal text-body-sm mt-10">Past: Engineering leader at Coinbase.</p>
