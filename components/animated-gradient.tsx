...
const Exp: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    class MiniGl {
                ...
                draw() {
                  context.useProgram(this.material.program),
                    this.material.uniformInstances.forEach(
                      ({ uniform: e, location: t }: any) => e.update(t)
                    ),
                    this.attributeInstances.forEach(
                      ({ attribute: e, location: t }: any) => e.use(t)
                    ),
      ...
      debug(arg0: string, arg1: { width: number; height: number }) {
        throw new Error("Method not implemented.");
      }
    ...
    function e(object: any, propertyName: any, val: any) {
      return (
    ...
    //Gradient object
    class Gradient {
      isGradientLegendVisible: void | boolean;
      conf: any;
      isScrolling: boolean;
      isIntersecting: any;
      width: number;
      ...
      constructor(...t: undefined[]) {
        e(this, "el", void 0),
          ...
          e(this, "initGradient", (selector: string) => {
      ...
      scrollingTimeout(scrollingTimeout: any) {
        throw new Error("Method not implemented.");
      }
      handleScrollEnd(handleScrollEnd: any, scrollingRefreshDelay: any): any {
        throw new Error("Method not implemented.");
      }
      ...
      //   }
      handleScroll(arg0: string, handleScroll: any) {
        throw new Error("Method not implemented.");
      }
      handleMouseDown(arg0: string, handleMouseDown: any) {
        throw new Error("Method not implemented.");
      }
      handleMouseUp(arg0: string, handleMouseUp: any) {
        throw new Error("Method not implemented.");
      }
      handleKeyDown(arg0: string, handleKeyDown: any) {
        throw new Error("Method not implemented.");
      }
      resize() {
        throw new Error("Method not implemented.");
