  ...
  return (
    <div className="py-40">
      ...
      <div className="ai-dialer-preview-gradient flex items-center flex-col justify-center rounded-default mb-15 mt-70">
        <h4 className="text-gray-f2f font-semibold text-h4">{landingContents.ourProductsSection.aiDialer.mainText}</h4>
        <h4 className="text-white font-normal text-h5">{landingContents.ourProductsSection.aiDialer.subText}</h4>
      </div>
    </div>
  );
};
