...
export const dhwaniFeaturesBig = [
  {
    id: "1",
...
export const dialsenseFeatures = [
  {
    id: "1",
...
export const dialsenseFeaturesBig = [
  {
    id: "1",
    Icon: <MdOutlineDialerSip size={80} fill="#777777" />,
    label: "lorem ipsum dolar",
  },
  {
    id: "2",
